...
// Used in CarrierSelection, QuoteGrid, RoutingRules, and other carrier tables
...
export function CarrierLogo({ carrierId, size = 32 }: { carrierId: string; size?: number }) {
  switch (carrierId) {
    ...
    default: return <MapfreLogo size={size} />
  }
}
...
const nameToId: Record<string, string> = {
  'Mapfre Mexico': 'mapfre',
  'GNP Seguros': 'gnp',
  'Chubb Mexico': 'chubb',
  'Zurich Mexico': 'zurich',
  'Afianzadora Aserta': 'aserta',
  'Fianzas Dorama': 'dorama',
}
